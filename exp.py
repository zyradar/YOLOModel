...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='C:/Users/HZY/Desktop/exp445/polygon_last.pt',
                        help='model.pt path(s)')
    parser.add_argument('--source', type=str, default='C:/Users/HZY/Pictures/317high_pickarea.avi',
