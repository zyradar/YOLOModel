...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default=r'runs/train/exp5/weights/best.pt', help='weights path')  # from yolov5/models/
    parser.add_argument('--img_size', nargs='+', type=int, default=[384, 640], help='image size')  # height, width
    parser.add_argument('--batch_size', type=int, default=1, help='batch size')
    parser.add_argument('--simplify', action='store_true', default=True, help='simplify onnx')
    parser.add_argument('--dynamic', action='store_false', default=False, help='enable dynamic axis in onnx model')
