    ...
    if pretrained:
        ...
        if ckpt['optimizer'] is not None:
            try:
                ...
                print("[INFO]::Use Pretrained Optimizer")
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data', type=str, default='data/orgin.yaml', help='data.yaml path')
    parser.add_argument('--hyp', type=str, default='data/PTS5-hpy-bs6.yaml', help='hyperparameters path')
